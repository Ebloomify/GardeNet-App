...
CREATE TABLE `cd_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8232 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of cd_log
-- ----------------------------
INSERT INTO `cd_log` VALUES ('8230', 'admin', 'admin', 'http://xiaoli.me/admin/Log/delete', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.75 Safari/537.36', '{\"id\":\"8229,8228,8227,8226,8225,8224,8223,8222,8221,8220,8219,8218,8217,8216,8215\"}', null, '1609853741', '2');
INSERT INTO `cd_log` VALUES ('8231', 'admin', 'admin', 'http://xiaoli.me/admin/Login/index.html', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.75 Safari/537.36', null, null, '1609854351', '1');
