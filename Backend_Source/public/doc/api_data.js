define({ "api": [
      ...
      "fields": {
        "输入参数：": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "is_re",
            "description": "<p>1 显示推荐分类 0显示普通 传1时 member_id和community_cate_id无效</p>"
          }
        ],
        "失败返回参数：": [
          {
      ...
      "fields": {
        "输入参数：": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "is_re",
            "description": "<p>1 显示推荐分类 0显示普通 传1时 member_id和discover_cate_id无效</p>"
          }
        ],
        "失败返回参数：": [
          {
  ...
  {
    "type": "get",
    "url": "/V1.Garden/deleteRemind",
    "title": "10、删除花园提醒",
    "group": "Garden",
    "version": "1.0.0",
    "description": "<p>删除花园提醒</p>",
    "parameter": {
      "fields": {
        "输入参数：": [
          {
        ...
        "输入参数：": [
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>查询类型 0已设置 1已提醒</p>"
          },
          {
            "group": "输入参数：",
            "type": "string",
  ...
  },
  {
    ...
    "filename": "./controller/V1/Garden.php",
    "groupTitle": "Garden",
    "name": "GetV1GardenView"
  },
  {
    "type": "getName",
    "url": "/V1.Garden/getName",
    "title": "06、查询名称",
    "group": "Garden",
    "version": "1.0.0",
      ...
      "fields": {
        "输入参数：": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "client_id",
            "description": "<p>客户端ID (选填，不填时取登录的id，登录id没有不推送)</p>"
          }
        ],
        "失败返回参数：": [
          {
  ...
  {
    "type": "get",
    "url": "/V1.QuestionAnswer/list",
    "title": "04、QA回答列表",
    "group": "QuestionAnswer",
    "version": "1.0.0",
    "description": "<p>QA回答列表</p>",
    "header": {
      "fields": {
        "Header": [
          {
      ...
      "fields": {
        "输入参数：": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "pid",
            "description": "<p>回复评论ID question_answer_id (可选)</p>"
          }
        ],
        "失败返回参数：": [
          {
      ...
      "fields": {
        "输入参数：": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "is_re",
            "description": "<p>1 显示推荐分类 0显示普通 传1时 question_cate_id无效</p>"
          }
        ],
        "失败返回参数：": [
          {
