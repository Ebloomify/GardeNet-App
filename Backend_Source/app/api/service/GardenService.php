...
class GardenService extends CommonService
{
    ...
    public static function getParam($data, $config)
    {
...
//        $thirdNotification->setIntent("intent:#Intent;component=$config[android_package_name]/你要打开的 activity 全路径;S.parm1=value1;S.parm2=value2;end");
